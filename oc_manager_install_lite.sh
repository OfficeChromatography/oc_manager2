...
echo "***********************************************************"
echo ""
echo "You are going to install OC_manager2 on your Raspberry Pi with Raspberry Pi OS lite."
echo ""
...
then
  ...
  echo ""
  yes | sudo apt-get install python-picamera
  ech ""
  echo "Installing the python modules pyserial and pytest"
  echo ""
