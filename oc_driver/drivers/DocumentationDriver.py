...
class DocumentationDriver():
    ...
    def take_a_picture(self, Path):
        ...
        if pictureType == 'UVA':
           ...
           camera.awb_mode = 'incandescent'  #or 'fluorescent' #can improve the contrast
           #Camera warm-up time
           sleep(30)
        ...
        #camera.brightness = 50 #between 0 and 100
        #camera.sharpness = -100 #between -100 and 100
        #camera.saturation = -100 #betweeen -100 and 100
        #camera.exposure_mode = 'verylong' #see picamera documentation
        #camera.awb_mode = 'fluorescent' #see picamera documentation
        #camera.image_effect = 'denoise' # or 'saturation'
        #camera.contrast = -100 #between -100 and 100
        #camera.iso = 800 #see picamera documentation
        #camera.sensor_mode = 3 #see picamera documentation
